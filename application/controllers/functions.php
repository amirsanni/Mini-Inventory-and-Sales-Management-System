...
{
    return [
        '.doc', '.docx', '.pdf', '.xls', '.ppt', '.pptx', '.csv', '.xlsx', '.dot', '.docm', '.dotx', '.dotm', '.docb',
 ...
 * @param string $subsciptionType
 * @return string
 */

function unsubscribeLink($userEmail, $userId, $userCode, $subsciptionType)
{
    $rand = generateRandomCode(20, 30, 40);
    $random = generateRandomCode(30, 40, 50);
